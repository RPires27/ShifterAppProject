import { StyleSheet, Text, TextInput, View, SafeAreaView, KeyboardAvoidingView, TouchableOpacity} from 'react-native'
...
const nav = useNavigation()
  ...
  return (
    <KeyboardAvoidingView style={styles.container}>
      ...
      <Text style = {{ fontSize: 20, color:'black', marginTop:20, fontFamily:'Quicksand-SemiBold'}}>Sem conta? <Text onPress={()=> nav.navigate("Register")} style = {{ color: '#0d61d6' }}>Registar</Text></Text>
